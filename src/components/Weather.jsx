...
const Weather = () => {
  ...
  useEffect(()=>{
    const fetchWeather = async ()=>{
      const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${search}&appid=e39061fedcac0a7ea596347ecc802964
    `);
    if(componentMounted){
  ...
  if (typeof data.main !== "undefined"){
    if(data.weather[0].main === "Clouds"){
      ...
      emoji = "fas-cloud-rain";
    }else if(data.weather[0].main === "Rain"){
      emoji = "fas-cloud-shower-heavy";
    }else if(data.weather[0].main === "Snow"){
      emoji = "fas-snow-flake";
    }else{
      emoji = "fa-smog";
    }
  }else{
            ...
            <div className="card text-white text-center border-0">
              ...
              <div className="card-img-overlay">
                ...
                <div className="bg-dark bg-opacity-50 py-2">
                  ...
                  <hr />
                  <i className={`fas ${emoji} fa-4x mb-2`}></i>
